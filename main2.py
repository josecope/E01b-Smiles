...
arcade.draw_ellipse_filled(face_x + 365, face_y + 330, 15, 25, open_color.black)
arcade.draw_ellipse_filled(face_x + 438, face_y + 330, 15, 25, open_color.black)
arcade.draw_circle_filled(face_x + 370, face_y + 339, 3, open_color.gray_2)
arcade.draw_circle_filled(face_x + 442, face_y + 339, 3, open_color.gray_2)
